...
ifneq (,$(project_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f project.make config=$(project_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f project.make clean
